    ...
    <>
      <div className="relative">
        ...
        <div className="bg-[#dcdbdb] block justify-center items-center min-h-screen">
          <div className="absolute top-1 right-0 flex flex-col gap-[5px]">
                    ...
                    <div>
                      ...
                      <div className="px-[15px] mb-5">
                        <div className="flex justify-evenly items-center">
                          ...
                          <button className="container-btn-file px-[55px] py-[5px]">
                            Upload File
                            <input
                              className="file "
